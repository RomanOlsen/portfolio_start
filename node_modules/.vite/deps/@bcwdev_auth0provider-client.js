...
var auth0_spa_js_production_esm_exports = {};
__export(auth0_spa_js_production_esm_exports, {
  Auth0Client: () => te,
...
var t, n, a, r, s, c, d, u, l, h, p, m, f, w, y, k, v, b, _, I, S, O, j, C, z, P, x, Z, K, W, E, R, U, L, D, X, N, J, H, Y, G, V, M, A, B, $, q, Q, ee, te, ie;
var init_auth0_spa_js_production_esm = __esm({
  "node_modules/@auth0/auth0-spa-js/dist/auth0-spa-js.production.esm.js"() {
    ...
    b = (e2) => ((e3) => decodeURIComponent(atob(e3).split("").map((e4) => "%" + ("00" + e4.charCodeAt(0).toString(16)).slice(-2)).join("")))(e2.replace(/_/g, "/").replace(/-/g, "+"));
    _ = async (e2, t2) => {
    ...
    $ = { memory: () => new P().enclosedCache, localstorage: () => new z() };
    q = (e2) => $[e2];
    Q = (t2) => {
...
// node_modules/@bcwdev/auth0provider-client/lib/Auth0Provider.js
var require_Auth0Provider = __commonJS({
  "node_modules/@bcwdev/auth0provider-client/lib/Auth0Provider.js"(exports, module) {
    var auth0 = (init_auth0_spa_js_production_esm(), __toCommonJS(auth0_spa_js_production_esm_exports));
    var AUTH_EVENTS = {
      LOADING: "LOADING",
      LOADED: "LOADED",
    ...
    var AuthPlugin = class {
      ...
      off(event, fn) {
        this._listeners[event] = this._listeners[event] || [];
        const i2 = this._listeners[event].indexOf(fn);
        if (i2 === -1) {
          return;
        }
        this._listeners[event].splice(i2, 1);
      }
      /**
       * @param {string} event
       * @param {any} [payload]
      ...
      emit(event, payload) {
        ...
        for (let i2 = 0; i2 < length; i2++) {
          const fn = this._listeners[event][i2];
      ...
      */
      async loginWithPopup(o2) {
        try {
          await instance.auth0Client.loginWithPopup(o2);
      ...
      */
      loginWithRedirect(o2) {
        o2 = o2 || {
          authorizationParams: { redirect_uri: window.location.href }
        };
        return instance.auth0Client.loginWithRedirect(o2);
      }
      /**
      * Returns the access token. If the token is invalid or missing, a new one is retrieved
      * @param {auth0.GetTokenSilentlyOptions} [o]
      */
      async getTokenSilently(o2) {
        const token = await instance.auth0Client.getTokenSilently(o2);
      ...
      */
      hasPermissions(permissions) {
        ...
        while (permissions.length) {
          ...
          const found = instance.identity.permissions.find((p2) => p2 === next);
          if (!found) {
            return false;
          }
        }
      ...
      */
      async getTokenWithPopup(o2) {
        const token = await instance.auth0Client.getTokenWithPopup(o2);
        instance.getIdentityClaims(token);
        instance.emit(AUTH_EVENTS.TOKEN_CHANGE, this);
        return token;
      }
      ...
      */
      logout(o2) {
        o2 = o2 || { logoutParams: { returnTo: window.location.origin } };
        const logout = instance.auth0Client.logout(o2);
        return logout;
      }
      verifyAuth0() {
        if (instance.auth0Client) {
          return instance;
        }
    ...
    function b64DecodeUnicode(str = ".") {
      try {
        return decodeURIComponent(
          ...
          atob(str).replace(/(.)/g, function(m2, p2) {
        ...
        console.error("[AUTH0-PROVIDER-ERROR] unable to decode token", e2);
      }
    }
    ...
    async function authSettled(to, from, next) {
      try {
        ...
        console.error("[AUTH_SETTLED]", e2);
        return next();
      }
    }
    var hasPermissions = (permissions) => instance.hasPermissions(permissions);
    module.exports = {
      AUTH_EVENTS,
      AuthPlugin,
      decodeToken,
...
// node_modules/@bcwdev/auth0provider-client/lib/index.js
var require_lib = __commonJS({
  "node_modules/@bcwdev/auth0provider-client/lib/index.js"(exports, module) {
    var { initialize, hasPermissions, authGuard, authSettled, decodeToken, AUTH_EVENTS, Identity } = require_Auth0Provider();
    module.exports = {
      AUTH_EVENTS,
      initialize,
      hasPermissions,
...
//# sourceMappingURL=@bcwdev_auth0provider-client.js.map
